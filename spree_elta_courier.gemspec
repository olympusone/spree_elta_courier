...
Gem::Specification.new do |s|
  ...
  s.name        = 'spree_elta_courier'
  s.version     = SpreeEltaCourier::VERSION
  s.summary     = 'Spree Commerce Elta Courier Extension'
  s.description = 'Adds the ability to manage Elta Courier vouchers to Spree stores.'

  s.required_ruby_version = '>= 3.0'

  s.author    = 'OlympusOne'
  s.email     = 'info@olympusone.com'
  s.homepage  = 'https://github.com/olympusone/spree_elta_courier'
  s.license   = 'MIT'
